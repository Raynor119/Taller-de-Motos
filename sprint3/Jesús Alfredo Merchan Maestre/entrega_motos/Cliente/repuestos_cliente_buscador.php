...
//HACER FILTRO DE BUSQUEDA EN NUEVA VISTA
    //if($_POST['marca'] == "todos"){
     //   echo ("todos");
    //}else if($_POST['marca'] == "honda"){
     //   echo ("honda");
    //}else if ($_POST['marca'] == "suzuki"){
     //   echo ("suzuki");
    //}else if ($_POST['marca'] == "yamaha"){
    //    echo ("yamaha");
    //}else{
    //    echo ("kawasaki");
    //}
  ...
  <header class="">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        ...
        <a class="btn btn-light fas fa-user" href="../Gestion_usuarios/InicioS.html"></a>
        <a class="btn btn-light fas fa-shopping-cart"></a>
        <input type="button" value="modo dark" id="botonsito" class="btn btn-dark" onclick="mododark() ">
      </div>
    ...
    <div class="row">
      <div class="izquierdo cajas col-lg-2 col-md-2 col-sm-2 col-xs-2">
        ...
        <form class="" action="repuestos_cliente_buscador.php" method="POST" >
          ...
          <input type="radio" name="marca" id="marca"  value="todos">Todos<br>
      ...
      <div class="derecho col-lg-9 col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row">
         ...
         //$rango = $_POST["rango"];
          ...
          if($_POST['marca'] == "todos"){
            header("Location:repuestos_cliente.php");
          }else if ($_POST['marca'] == "honda"){
          
            //SELECT marca,imagen from repuestos WHERE marca = 'honda' AND precio <=20000;
            $todos = 'marca';
          $consulta = "SELECT marca,descripcion,imagen from repuestos WHERE marca = 'honda'";

            //AQUI MUESTRO LA MARCA Y LA IMAGEN LUEGO DEBO FILTRAR EL PRECIO
          ...
          <?php
            ...
            $todos = 'marca';
            $consulta = "SELECT marca,imagen from repuestos WHERE marca = 'suzuki' AND precio <=$rango";
            ...
            <?php
                ...
                $todos = 'marca';
                $consulta = "SELECT marca,imagen from repuestos WHERE marca = 'yamaha' AND precio <=$rango";
                ...
                else if ($_POST['marca'] == "kawasaki"){
            
                    $todos = 'marca';
                    $consulta = "SELECT marca,imagen from repuestos WHERE marca = 'kawasaki' AND precio <=$rango";
